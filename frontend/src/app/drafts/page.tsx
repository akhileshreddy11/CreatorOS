...
export default function DraftsPage() {
  ...
  return <DashboardLayout><div className="space-y-8">
    ...
    {!loading && drafts.length > 0 && <div className="space-y-5">{drafts.map(draft => { const validationPassed = draft.validation.valid !== false; const video = browserMediaUrl(draft.content.media); return <article key={draft.id} className="rounded-3xl border border-zinc-800 bg-zinc-900 p-6 transition hover:border-zinc-700">
